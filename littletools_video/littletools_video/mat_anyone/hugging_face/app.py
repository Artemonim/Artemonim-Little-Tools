"""
    ...
    Classes/Functions:
    - MaskGenerator (line 86):
      - Functions:
        - parse_augment() (line 66)
        - get_prompt(click_state, click_input) (line 103)
        - select_video_template(image_selection_slider, video_state, interactive_state) (line 122)
        - select_image_template(image_selection_slider, video_state, interactive_state) (line 140)
        - get_end_number(track_pause_number_slider, video_state, interactive_state) (line 159)
        - add_multi_mask(video_state, interactive_state, mask_dropdown) (line 215)
        - clear_click(video_state, click_state) (line 236)
        - remove_multi_mask(interactive_state, mask_dropdown) (line 242)
        - show_mask(video_state, interactive_state, mask_dropdown) (line 249)
        - add_audio_to_video(video_path, audio_path, output_path) (line 393)
...
Classes/Functions:
- MaskGenerator (line 84):
  - Functions:
    - parse_augment() (line 64)
    - get_prompt(click_state, click_input) (line 101)
    - select_video_template(image_selection_slider, video_state, interactive_state) (line 120)
    - select_image_template(image_selection_slider, video_state, interactive_state) (line 138)
    - get_end_number(track_pause_number_slider, video_state, interactive_state) (line 157)
    - add_multi_mask(video_state, interactive_state, mask_dropdown) (line 213)
    - clear_click(video_state, click_state) (line 234)
    - remove_multi_mask(interactive_state, mask_dropdown) (line 240)
    - show_mask(video_state, interactive_state, mask_dropdown) (line 247)
    - add_audio_to_video(video_path, audio_path, output_path) (line 391)
--- END AUTO-GENERATED DOCSTRING ---
"""
