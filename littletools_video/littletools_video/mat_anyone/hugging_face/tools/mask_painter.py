"""
    ...
    Classes/Functions:
      - Functions:
        - colormap(rgb=True) (line 25)
        - vis_add_mask(image, background_mask, contour_mask, background_color, contour_color, background_alpha, contour_alpha) (line 121)
        - mask_generator_00(mask, background_radius, contour_radius) (line 138)
        - mask_generator_01(mask, background_radius, contour_radius) (line 153)
        - mask_generator_10(mask, background_radius, contour_radius) (line 166)
        - mask_generator_11(mask, background_radius, contour_radius) (line 183)
        - mask_painter(input_image, input_mask, background_alpha=0.5, background_blur_radius=7, contour_width=3, contour_color=3, contour_alpha=1, mode='11') (line 199)
