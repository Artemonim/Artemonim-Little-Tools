"""
    ...
    Classes/Functions:
      - Functions:
        - colormap(rgb=True) (line 24)
        - vis_add_mask(image, mask, color, alpha) (line 120)
        - point_painter(input_image, input_points, point_color=5, point_alpha=0.9, point_radius=15, contour_color=2, contour_width=5) (line 126)
        - mask_painter(input_image, input_mask, mask_color=5, mask_alpha=0.7, contour_color=1, contour_width=3) (line 151)
        - background_remover(input_image, input_mask) (line 173)
