"""
    ...
    Classes/Functions:
    - ImageFeatureStore (line 21):
      - _encode_feature(index: int, image: torch.Tensor, last_feats=None) -> None (line 36)
      - delete(index: int) -> None (line 72)
      - __len__() (line 76)
      - __del__() (line 79)
...
Classes/Functions:
- ImageFeatureStore (line 19):
  - _encode_feature(index: int, image: torch.Tensor, last_feats=None) -> None (line 34)
  - delete(index: int) -> None (line 70)
  - __len__() (line 74)
  - __del__() (line 77)
--- END AUTO-GENERATED DOCSTRING ---
"""
