"""
    ...
    Classes/Functions:
    - KeyValueMemoryStore (line 48):
      - update_bucket_usage(bucket_id: int, usage: torch.Tensor) -> None (line 193)
      - remove_old_memory(bucket_id: int, max_len: int) -> None (line 255)
      - remove_obsolete_features(bucket_id: int, max_size: int) -> None (line 258)
      - get_usage(bucket_id: int) -> torch.Tensor (line 325)
      - purge_except(obj_keep_idx: List[int]) (line 387)
      - clear_non_permanent_memory() (line 414)
      - get_v_size(obj_id: int) -> int (line 419)
      - size(bucket_id: int) -> int (line 422)
      - perm_size(bucket_id: int) -> int (line 428)
      - non_perm_size(bucket_id: int) -> int (line 431)
      - engaged(bucket_id: Optional[int] = None) -> bool (line 434)
      - num_objects() -> int (line 441)
      - key() -> Dict[int, torch.Tensor] (line 445)
      - value() -> Dict[int, torch.Tensor] (line 449)
      - shrinkage() -> Dict[int, torch.Tensor] (line 453)
      - selection() -> Dict[int, torch.Tensor] (line 457)
      - __contains__(key) (line 460)
      - Functions:
        - _add_last_dim(dictionary, key, new_value, prepend=False) (line 38)
...
Classes/Functions:
- KeyValueMemoryStore (line 46):
  - update_bucket_usage(bucket_id: int, usage: torch.Tensor) -> None (line 191)
  - remove_old_memory(bucket_id: int, max_len: int) -> None (line 253)
  - remove_obsolete_features(bucket_id: int, max_size: int) -> None (line 256)
  - get_usage(bucket_id: int) -> torch.Tensor (line 323)
  - purge_except(obj_keep_idx: List[int]) (line 385)
  - clear_non_permanent_memory() (line 412)
  - get_v_size(obj_id: int) -> int (line 417)
  - size(bucket_id: int) -> int (line 420)
  - perm_size(bucket_id: int) -> int (line 426)
  - non_perm_size(bucket_id: int) -> int (line 429)
  - engaged(bucket_id: Optional[int] = None) -> bool (line 432)
  - num_objects() -> int (line 439)
  - key() -> Dict[int, torch.Tensor] (line 443)
  - value() -> Dict[int, torch.Tensor] (line 447)
  - shrinkage() -> Dict[int, torch.Tensor] (line 451)
  - selection() -> Dict[int, torch.Tensor] (line 455)
  - __contains__(key) (line 458)
  - Functions:
    - _add_last_dim(dictionary, key, new_value, prepend=False) (line 36)
--- END AUTO-GENERATED DOCSTRING ---
"""
