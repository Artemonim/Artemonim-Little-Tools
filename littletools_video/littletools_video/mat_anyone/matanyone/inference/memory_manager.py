"""
    ...
    Classes/Functions:
    - MemoryManager (line 40):
      - update_config(cfg: DictConfig) -> None (line 87)
      - _readout(affinity, v, uncert_mask=None) -> torch.Tensor (line 107)
      - _get_mask_by_ids(mask: torch.Tensor, obj_ids: List[int]) -> torch.Tensor (line 126)
      - _get_sensory_by_ids(obj_ids: List[int]) -> torch.Tensor (line 130)
      - _get_object_mem_by_ids(obj_ids: List[int]) -> torch.Tensor (line 133)
      - _get_visual_values_by_ids(obj_ids: List[int]) -> torch.Tensor (line 136)
      - purge_except(obj_keep_idx: List[int]) -> None (line 439)
      - compress_features(bucket_id: int) -> None (line 450)
      - initialize_sensory_if_needed(sample_key: torch.Tensor, ids: List[int]) (line 512)
      - update_sensory(sensory: torch.Tensor, ids: List[int]) (line 521)
      - get_sensory(ids: List[int]) (line 526)
      - clear_non_permanent_memory() (line 530)
      - clear_sensory_memory() (line 535)
      - clear_work_mem() (line 538)
      - clear_obj_mem() (line 543)
...
Classes/Functions:
- MemoryManager (line 38):
  - update_config(cfg: DictConfig) -> None (line 85)
  - _readout(affinity, v, uncert_mask=None) -> torch.Tensor (line 105)
  - _get_mask_by_ids(mask: torch.Tensor, obj_ids: List[int]) -> torch.Tensor (line 124)
  - _get_sensory_by_ids(obj_ids: List[int]) -> torch.Tensor (line 128)
  - _get_object_mem_by_ids(obj_ids: List[int]) -> torch.Tensor (line 131)
  - _get_visual_values_by_ids(obj_ids: List[int]) -> torch.Tensor (line 134)
  - purge_except(obj_keep_idx: List[int]) -> None (line 437)
  - compress_features(bucket_id: int) -> None (line 448)
  - initialize_sensory_if_needed(sample_key: torch.Tensor, ids: List[int]) (line 510)
  - update_sensory(sensory: torch.Tensor, ids: List[int]) (line 519)
  - get_sensory(ids: List[int]) (line 524)
  - clear_non_permanent_memory() (line 528)
  - clear_sensory_memory() (line 533)
  - clear_work_mem() (line 536)
  - clear_obj_mem() (line 541)
--- END AUTO-GENERATED DOCSTRING ---
"""
...
from matanyone.model.utils.memory_utils import do_softmax
from matanyone.model.utils.memory_utils import get_similarity
