"""
    ...
    Classes/Functions:
    - ObjectManager (line 29):
      - _recompute_obj_id_to_obj_mapping() -> None (line 43)
      - delete_objects(obj_ids_to_remove: Union[int, List[int]]) -> None (line 78)
      - tmp_to_obj_cls(mask) -> torch.Tensor (line 123)
      - get_tmp_to_obj_mapping() -> Dict[int, ObjectInfo] (line 130)
      - realize_dict(obj_dict, dim=1) -> torch.Tensor (line 134)
      - make_one_hot(cls_mask) -> torch.Tensor (line 144)
      - all_obj_ids() -> List[int] (line 157)
      - num_obj() -> int (line 161)
      - has_all(objects: List[int]) -> bool (line 164)
      - find_object_by_id(obj_id) -> ObjectInfo (line 170)
      - find_tmp_by_id(obj_id) -> int (line 173)
...
Classes/Functions:
- ObjectManager (line 27):
  - _recompute_obj_id_to_obj_mapping() -> None (line 41)
  - delete_objects(obj_ids_to_remove: Union[int, List[int]]) -> None (line 76)
  - tmp_to_obj_cls(mask) -> torch.Tensor (line 121)
  - get_tmp_to_obj_mapping() -> Dict[int, ObjectInfo] (line 128)
  - realize_dict(obj_dict, dim=1) -> torch.Tensor (line 132)
  - make_one_hot(cls_mask) -> torch.Tensor (line 142)
  - all_obj_ids() -> List[int] (line 155)
  - num_obj() -> int (line 159)
  - has_all(objects: List[int]) -> bool (line 162)
  - find_object_by_id(obj_id) -> ObjectInfo (line 168)
  - find_tmp_by_id(obj_id) -> int (line 171)
--- END AUTO-GENERATED DOCSTRING ---
"""
