"""
    ...
    Classes/Functions:
    - LinearPredictor (line 23):
      - forward(pix_feat: torch.Tensor, x: torch.Tensor) -> torch.Tensor (line 28)
    - DirectPredictor (line 39):
      - forward(x: torch.Tensor) -> torch.Tensor (line 44)
    - AuxComputer (line 50):
