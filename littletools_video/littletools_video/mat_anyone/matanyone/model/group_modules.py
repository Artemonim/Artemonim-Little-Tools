"""
    ...
    Classes/Functions:
    - GConv2d (line 56):
      - forward(g: torch.Tensor) -> torch.Tensor (line 57)
    - GroupResBlock (line 63):
      - forward(g: torch.Tensor) -> torch.Tensor (line 75)
    - MainToGroupDistributor (line 84):
    - GroupFeatureFusionBlock (line 129):
      - forward(x: torch.Tensor, g: torch.Tensor) -> torch.Tensor (line 142)
...
Classes/Functions:
- GConv2d (line 54):
  - forward(g: torch.Tensor) -> torch.Tensor (line 55)
- GroupResBlock (line 61):
  - forward(g: torch.Tensor) -> torch.Tensor (line 73)
- MainToGroupDistributor (line 82):
- GroupFeatureFusionBlock (line 127):
  - forward(x: torch.Tensor, g: torch.Tensor) -> torch.Tensor (line 140)
--- END AUTO-GENERATED DOCSTRING ---
"""
