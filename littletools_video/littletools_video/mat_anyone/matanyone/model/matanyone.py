"""
    ...
    Classes/Functions:
    - MatAnyone (line 43):
      - _get_others(masks: torch.Tensor) -> torch.Tensor (line 88)
      - encode_image(image: torch.Tensor, seq_length=None, last_feats=None) -> (Iterable[torch.Tensor], torch.Tensor) (line 121)
      - forward(*args, **kwargs) (line 372)
      - load_weights(src_dict, init_as_zero_if_needed=False) -> None (line 375)
      - device() -> torch.device (line 434)
...
Classes/Functions:
- MatAnyone (line 41):
  - _get_others(masks: torch.Tensor) -> torch.Tensor (line 86)
  - encode_image(image: torch.Tensor, seq_length=None, last_feats=None) -> (Iterable[torch.Tensor], torch.Tensor) (line 119)
  - forward(*args, **kwargs) (line 370)
  - load_weights(src_dict, init_as_zero_if_needed=False) -> None (line 373)
  - device() -> torch.device (line 432)
--- END AUTO-GENERATED DOCSTRING ---
"""
...
from matanyone.model.big_modules import KeyProjection
from matanyone.model.big_modules import MaskDecoder
from matanyone.model.big_modules import MaskEncoder
from matanyone.model.big_modules import PixelEncoder
from matanyone.model.big_modules import PixelFeatureFuser
from matanyone.model.big_modules import UncertPred
...
from matanyone.model.utils.memory_utils import get_affinity
from matanyone.model.utils.memory_utils import readout
