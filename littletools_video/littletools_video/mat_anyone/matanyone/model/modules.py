"""
    ...
    Classes/Functions:
    - UpsampleBlock (line 37):
      - forward(in_g: torch.Tensor, skip_f: torch.Tensor) -> torch.Tensor (line 43)
    - MaskUpsampleBlock (line 50):
      - forward(in_g: torch.Tensor, skip_f: torch.Tensor) -> torch.Tensor (line 57)
    - DecoderFeatureProcessor (line 64):
    - SensoryUpdater_fullscale (line 93):
      - forward(g: torch.Tensor, h: torch.Tensor) -> torch.Tensor (line 109)
    - SensoryUpdater (line 127):
      - forward(g: torch.Tensor, h: torch.Tensor) -> torch.Tensor (line 141)
    - SensoryDeepUpdater (line 157):
      - forward(g: torch.Tensor, h: torch.Tensor) -> torch.Tensor (line 166)
    - ResBlock (line 176):
      - forward(g: torch.Tensor) -> torch.Tensor (line 188)
      - Functions:
        - _recurrent_update(h: torch.Tensor, values: torch.Tensor) -> torch.Tensor (line 82)
...
Classes/Functions:
- UpsampleBlock (line 35):
  - forward(in_g: torch.Tensor, skip_f: torch.Tensor) -> torch.Tensor (line 41)
- MaskUpsampleBlock (line 48):
  - forward(in_g: torch.Tensor, skip_f: torch.Tensor) -> torch.Tensor (line 55)
- DecoderFeatureProcessor (line 62):
- SensoryUpdater_fullscale (line 91):
  - forward(g: torch.Tensor, h: torch.Tensor) -> torch.Tensor (line 107)
- SensoryUpdater (line 125):
  - forward(g: torch.Tensor, h: torch.Tensor) -> torch.Tensor (line 139)
- SensoryDeepUpdater (line 155):
  - forward(g: torch.Tensor, h: torch.Tensor) -> torch.Tensor (line 164)
- ResBlock (line 174):
  - forward(g: torch.Tensor) -> torch.Tensor (line 186)
  - Functions:
    - _recurrent_update(h: torch.Tensor, values: torch.Tensor) -> torch.Tensor (line 80)
--- END AUTO-GENERATED DOCSTRING ---
"""
...
from matanyone.model.group_modules import GroupResBlock
from matanyone.model.group_modules import MainToGroupDistributor
from matanyone.model.group_modules import downsample_groups
from matanyone.model.group_modules import upsample_groups
