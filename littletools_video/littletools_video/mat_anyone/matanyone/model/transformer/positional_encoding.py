"""
    ...
    Classes/Functions:
    - PositionalEncoding (line 32):
      - forward(tensor: torch.Tensor) -> torch.Tensor (line 55)
      - Functions:
        - get_emb(sin_inp: torch.Tensor) -> torch.Tensor (line 24)
...
Classes/Functions:
- PositionalEncoding (line 30):
  - forward(tensor: torch.Tensor) -> torch.Tensor (line 53)
  - Functions:
    - get_emb(sin_inp: torch.Tensor) -> torch.Tensor (line 22)
--- END AUTO-GENERATED DOCSTRING ---
"""
