"""
    ...
    Classes/Functions:
    - SelfAttention (line 31):
    - CrossAttention (line 72):
    - FFN (line 133):
      - forward(x: torch.Tensor) -> torch.Tensor (line 145)
    - PixelFFN (line 153):
      - forward(pixel: torch.Tensor, pixel_flat: torch.Tensor) -> torch.Tensor (line 159)
    - OutputFFN (line 171):
      - forward(x: torch.Tensor) -> torch.Tensor (line 182)
      - Functions:
        - _get_activation_fn(activation: str) -> Callable[[Tensor], Tensor] (line 187)
...
Classes/Functions:
- SelfAttention (line 29):
- CrossAttention (line 70):
- FFN (line 131):
  - forward(x: torch.Tensor) -> torch.Tensor (line 143)
- PixelFFN (line 151):
  - forward(pixel: torch.Tensor, pixel_flat: torch.Tensor) -> torch.Tensor (line 157)
- OutputFFN (line 169):
  - forward(x: torch.Tensor) -> torch.Tensor (line 180)
  - Functions:
    - _get_activation_fn(activation: str) -> Callable[[Tensor], Tensor] (line 185)
--- END AUTO-GENERATED DOCSTRING ---
"""
