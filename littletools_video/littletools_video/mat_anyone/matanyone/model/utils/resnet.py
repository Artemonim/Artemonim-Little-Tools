"""
    ...
    - Bottleneck (line 99):
      - forward(x) (line 122)
    - ResNet (line 145):
      - _make_layer(block, planes, blocks, stride=1, dilation=1) (line 168)
      - Functions:
        - load_weights_add_extra_dim(target, source_state, extra_dim=1) (line 28)
        - conv3x3(in_planes, out_planes, stride=1, dilation=1) (line 55)
        - resnet18(pretrained=True, extra_dim=0) (line 190)
        - resnet50(pretrained=True, extra_dim=0) (line 199)
