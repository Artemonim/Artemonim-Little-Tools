"""
    ...
    Classes/Functions:
      - Functions:
        - read_frame_from_videos(frame_root) (line 27)
        - get_video_paths(input_root) (line 49)
        - str_to_list(value) (line 58)
        - gen_dilate(alpha, min_kernel_size, max_kernel_size) (line 62)
        - gen_erosion(alpha, min_kernel_size, max_kernel_size) (line 70)
...
Classes/Functions:
  - Functions:
    - read_frame_from_videos(frame_root) (line 25)
    - get_video_paths(input_root) (line 47)
    - str_to_list(value) (line 56)
    - gen_dilate(alpha, min_kernel_size, max_kernel_size) (line 60)
    - gen_erosion(alpha, min_kernel_size, max_kernel_size) (line 68)
--- END AUTO-GENERATED DOCSTRING ---
"""
