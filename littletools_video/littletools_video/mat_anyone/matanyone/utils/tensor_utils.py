"""
    ...
    Classes/Functions:
      - Functions:
        - pad_divide_by(in_img: torch.Tensor, d: int) -> (torch.Tensor, Iterable[int]) (line 22)
        - unpad(img: torch.Tensor, pad: Iterable[int]) -> torch.Tensor (line 40)
        - aggregate(prob: torch.Tensor, dim: int) -> torch.Tensor (line 62)
        - cls_to_one_hot(cls_gt: torch.Tensor, num_objects: int) -> torch.Tensor (line 74)
...
Classes/Functions:
  - Functions:
    - pad_divide_by(in_img: torch.Tensor, d: int) -> (torch.Tensor, Iterable[int]) (line 20)
    - unpad(img: torch.Tensor, pad: Iterable[int]) -> torch.Tensor (line 38)
    - aggregate(prob: torch.Tensor, dim: int) -> torch.Tensor (line 60)
    - cls_to_one_hot(cls_gt: torch.Tensor, num_objects: int) -> torch.Tensor (line 72)
--- END AUTO-GENERATED DOCSTRING ---
"""
