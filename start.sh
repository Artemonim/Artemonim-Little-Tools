...
function install_environment {
    ...
    echo -e "${COLOR_YELLOW}* Installing/updating all LittleTools packages...${COLOR_NC}"
    ...
    local Requirements=()
    Requirements+=("-e ./littletools_cli")
    Requirements+=("-e ./littletools_core")
    Requirements+=("-e ./littletools_speech")
    Requirements+=("-e ./littletools_txt")
    Requirements+=("-e ./littletools_video")

    local ParentDir
    ParentDir=$(dirname "$ScriptDir")
    local AgentDocstringsGeneratorPath="$ParentDir/AgentDocstringsGenerator"
    if [ -d "$AgentDocstringsGeneratorPath" ]; then
        Requirements+=("-e file://$AgentDocstringsGeneratorPath")
    fi
